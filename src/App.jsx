...
function App() {
  ...
  return (
    <Stack sx={{width: '100%', height: '100%', alignItems: 'center', justifyContent: 'center', maxWidth: '1600px', margin: '0 auto'}}>
      <Header />
      <Stack sx={{width: {xs: '90%', sm: '90%', md: '80%'}, height: {xs: '700px', sm: '900px', md: '300px'},
        ...
        <img src="./assets/images/XMLID_1124_.png" alt="bolinhas" id='steps' style={{position: 'absolute', left: '-100px', top: '-150px', width: '300px', height: '300px'}} />
        <Steps />
      </Stack>
      <Box sx={{width: '100%', height: {xs: '850px', sm: '650px', md: '650px'}, backgroundImage: 'url(./assets/images/main-bg.png)',
        backgroundRepeat: 'no-repeat', backgroundSize: 'cover', display: 'flex', alignItems: 'center', justifyContent: 'center'}}
        id='benefits'
      >
        <Benefits />
      </Box>
      <Box sx={{width: '100%', height: {xs: '750px', sm: '700px',md: '650px'},
